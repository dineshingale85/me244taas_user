...
import 'package:Ziepick/app/app_theme.dart';
...
import 'package:Ziepick/utils/network/api_call_trigger.dart';
import 'package:Ziepick/utils/ui_utils.dart';
import 'package:Ziepick/utils/webview_screen.dart';
            ...
            child: Column(children: <Widget>[
              ...
              Column(
                ...
                children: [
                  ...
                  /*HiveUtils.isUserAuthenticated() ? customTile(
                    context,
                    title: "Address".translate(context),
                    svgImagePath: AppIcons.locationIcon,
                    onTap: () async {
                  ...
                  if (HiveUtils.isUserAuthenticated()) ...[
                    customTile(
                      context,
                      title: "Referral".translate(context),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => MyWebViewScreen(
                              url:
                                  "https://mee24taas.com/refer/${HiveUtils.getUserDetails().id}",
                              title: "Referral",
                            ),
                          ),
                        );
                  ...
                  if (HiveUtils.isUserAuthenticated()) ...[
                    customTile(
                      context,
                      title: "Order History".translate(context),
                      svgImagePath: AppIcons.gridViewIcon,
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MyWebViewScreen(
                              url:
                                  "https://mee24taas.com/user/order-history/${HiveUtils.getUserDetails().id}",
                              title: "Order History",
                            ),
                          ),
                        );
                  ...
                  if (HiveUtils.isUserAuthenticated()) ...[
                    customTile(
                      context,
                      title: "Youtube".translate(context),
                      svgImagePath: AppIcons.gridViewIcon,
                      onTap: () {
                        Navigator.push(
                          context,
