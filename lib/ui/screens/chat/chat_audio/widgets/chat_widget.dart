...
class ChatMessageState extends State<ChatMessage>
  ...
  bool _isValidUrlForPreview(String input) {
    // Only allow URLs with http:// or https:// protocol for preview
    try {
                                  ...
                                  SelectableText.rich(
                                    TextSpan(
                                      ...
                                      children: _replaceLink().map((data) {
                                        ...
                                        if (_isLink(data)) {
                                          //This will notify priview object that it has link - only for valid URLs
                                          if (_isValidUrlForPreview(data)) {
